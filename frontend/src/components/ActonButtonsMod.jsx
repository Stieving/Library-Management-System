...
//   // Check if an ISBN has been entered
//   const isIsbnEntered = isbnInput.trim() !== '';

//   // Buttons for public actions (not disabled by login status)
//   const isPublicButtonDisabled = loading;

//   // Buttons for authenticated actions (disabled if not logged in or no ISBN entered)
//   const isAuthenticatedActionButtonDisabled = loading || !isLoggedIn || !isIsbnEntered;
...
//             disabled={loading} // Only disabled when loading, not by login status
//           />
//           <button
...
//             disabled={isPublicButtonDisabled} // Only disabled when loading
//           >
//             Find Book
//           </button>
//         </div>
...
//             disabled={isAuthenticatedActionButtonDisabled}
//           >
//             Borrow
//           </button>
//           <button
